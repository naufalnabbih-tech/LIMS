 ...
 <div class="flex h-full flex-col bg-white">
     ...
     <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
         ...
         <!-- Sample Submission -->
         <a href="{{ route('sample-submissions') }}" wire:navigate
             class="flex items-center px-3 py-2 text-sm font-medium rounded-md {{ request()->routeIs('sample-submissions') ? 'bg-blue-50 text-blue-700 border-r-2 border-blue-600' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }} transition-all duration-150">
             <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
