                        ...
                        @if ($selectedAnalysisSample)
                            ...
                            <div class="bg-gray-50 rounded-xl p-6 mb-6">
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Chemical
                                            Material</label>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-base font-medium text-gray-900">
                                            {{ $selectedAnalysisSample->batch_lot ?? 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="mb-4 bg-red-50 border-l-4 border-red-400 text-red-700 p-3 rounded-r-lg">
                                        <div class="flex">
                                            <div class="flex-shrink-0">
                                                ...
                                                001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707
                            ...
                            @elseif ($analysisMethod === 'joint')
                                <div class="mb-6 space-y-4">
                                    ...
                                    <x-form.dropdown
                                        ...
                                        :items="$operators->filter(fn($op) => $op->id != auth()->id())"
                                        modelName="secondaryAnalystId"
                                        :selectedValue="$secondaryAnalystId"
                                        placeholder="Select an analyst to assist"
                                        ringColor="green"
                                        required />
                                ...
                                <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                    ...
                                    <div class="mt-2">
                                        <p class="text-sm text-gray-500 mb-3">
                                            Apakah Anda yakin ingin memulai analisis untuk sample ini? Status sample
                                            akan
                                        ...
                                        <div class="bg-gray-50 rounded-lg p-3 text-sm">
                                            <div class="space-y-2">
                                                ...
                                                @if ($analysisMethod === 'joint')
                                                    <div class="flex justify-between">
                                                        <span class="text-gray-600 font-medium">Secondary
                                                            Analyst:</span>
