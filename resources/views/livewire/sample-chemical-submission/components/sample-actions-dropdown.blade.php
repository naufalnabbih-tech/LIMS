    ...
    <div x-data="sampleDropdown()" x-init="initGlobalDropdown()" @click.away="handleClickAway()"
        ...
        <div x-show="isOpen" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="max-h-96 overflow-y-auto custom-scrollbar">
                ...
                <!-- Process Actions -->
                <div class="p-3"
                    x-show="sampleData.canStartAnalysis || sampleData.canContinueAnalysis || sampleData.canHandOver || sampleData.canTakeOver">
                    <div class="px-2 py-1.5">
        ...
        function sampleDropdown() {
            return {
                ...
                callLivewireMethod(method, sampleId) {
                    try {
                        // Find the main SampleChemicalSubmission component
                        ...
                        if (mainComponent) {
                            ...
                            if (livewireComponent && typeof livewireComponent[method] === 'function') {
                                ...
                                console.error(`Method ${method} not found on component`, {
                                    ...
                                    availableMethods: livewireComponent ? Object.keys(livewireComponent).filter(k =>
                                        typeof livewireComponent[k] === 'function') : 'Component not found'
                                });
                            }
                        } else {
