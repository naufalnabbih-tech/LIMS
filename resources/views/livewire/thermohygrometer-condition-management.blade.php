   ...
   <div class="flex flex-col">
       ...
       <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-4">
           <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
               <div>
                   <h2 class="text-xl font-semibold text-gray-900">Thermohygrometer Condition Management</h2>
                   <p class="text-sm text-gray-600 mt-1">Manage thermohygrometer conditions, shifts, and maintenance schedules</p>
               </div>
                       ...
                       <tr>
                           <td colspan="6" class="px-4 py-12 text-center">
                               <div class="flex flex-col items-center justify-center">
                                   ...
                                   <p class="text-sm text-gray-500 mb-4">Get started by adding your first thermohygrometer condition</p>
                                   <button wire:click="openCreateModal"
           ...
           <div class="relative w-full max-w-7xl bg-white rounded-2xl shadow-2xl my-8 flex flex-col max-h-[90vh]">
               ...
               <div class="flex justify-between items-center px-8 pt-8 pb-4 border-b flex-shrink-0">
                   <h3 class="text-2xl font-bold">
                       ...
                       @else
                           Add Condition for All Thermohygrometers
                       @endif
                   </h3>
               ...
               <div class="flex-1 overflow-y-auto px-8 py-6">
                   ...
                   @if($isViewing)
                       ...
                       <div class="space-y-4">
                           ...
                           <div>
                               <label class="block text-sm font-bold mb-3">All Thermohygrometer Conditions</label>
                               <div class="max-h-64 overflow-y-auto border border-gray-200 rounded-lg">
                                   <table class="min-w-full divide-y divide-gray-200">
                                       <thead class="bg-gray-50 sticky top-0">
                                           <tr>
                                               <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                   Thermohygrometer Name
                                               </th>
                                               <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                   Condition
                                               </th>
                                       ...
                                       <tbody class="bg-white divide-y divide-gray-200">
                                           @foreach($thermohygrometerConditions as $thermohygrometerData)
                                               <tr class="hover:bg-gray-50">
                                                   <td class="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900">
                                                       {{ $thermohygrometerData['thermohygrometer_name'] }}
                                                   </td>
                                                   <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                                       <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                                           @if($thermohygrometerData['condition'] === 'good') bg-green-100 text-green-800
                                                           @else bg-red-100 text-red-800
                                                           @endif">
                                                           {{ ucfirst($thermohygrometerData['condition']) }}
                                                       </span>
                                                   </td>
                                                   <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                                       @if($thermohygrometerData['condition'] === 'good' && $thermohygrometerData['temperature'])
                                                           {{ $thermohygrometerData['temperature'] }}°C
                                                       @else
                                                           <span class="text-gray-400 italic">-</span>
                                                       @endif
                                                   </td>
                                                   <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                                       @if($thermohygrometerData['condition'] === 'good' && $thermohygrometerData['humidity'])
                                                           {{ $thermohygrometerData['humidity'] }}%
                                                       @else
                                                           <span class="text-gray-400 italic">-</span>
                                                       @endif
                                                   </td>
                                                   <td class="px-4 py-3 text-sm text-gray-900">
                                                       @if($thermohygrometerData['description'])
                                                           {{ $thermohygrometerData['description'] }}
                                                       @else
                           ...
                           <div class="mb-6">
                               <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-200 mb-4">
                                   <div class="flex items-center">
                                       ...
                                       <div class="ml-3">
                                           <h3 class="text-lg font-semibold text-blue-900">Set Condition for All Thermohygrometers</h3>
                                           <p class="text-sm text-blue-700 mt-1">Configure the condition, temperature, humidity, and notes for each thermohygrometer device</p>
                                       </div>
                                   </div>
                               </div>
                                   ...
                                   <div class="max-h-96 overflow-y-auto">
                                       <table class="min-w-full divide-y divide-gray-200">
                                           <thead class="bg-gradient-to-r from-gray-50 to-gray-100 sticky top-0 z-10">
                                               <tr>
                                                   <th class="px-4 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-1/5 border-r border-gray-200">
                                                       <div class="flex items-center">
                                                   ...
                                                   <th class="px-4 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider w-1/6 border-r border-gray-200">
                                                       <div class="flex items-center">
                                                           <svg class="w-4 h-4 text-gray-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                               ...
                                               <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-200 border-l-4 border-transparent hover:border-blue-300"
                                                   ...
                                                   <td class="px-4 py-4 text-sm font-semibold text-gray-800 align-top border-r border-gray-100">
                                                       <div class="flex items-center">
                                                           ...
                                                           <span class="truncate">{{ $thermohygrometerData['thermohygrometer_name'] }}</span>
                                                       </div>
                                                   </td>
                                                   <td class="px-4 py-4 text-sm text-gray-900 align-top border-r border-gray-100">
                                                       <div class="space-y-3">
                                                           @foreach($conditionOptions as $key => $label)
                                                               <label class="flex items-center cursor-pointer hover:bg-white hover:shadow-sm rounded-lg p-2 transition-all duration-150">
                                                                   <input type="radio"
                                                                       wire:model.live="thermohygrometerConditions.{{ $thermohygrometerId }}.condition"
                                                                       value="{{ $key }}"
                                                       ...
                                                       @error('thermohygrometerConditions.' . $thermohygrometerId . '.condition')
                                                   ...
                                                   <td class="px-4 py-4 text-sm text-gray-900 align-top border-r border-gray-100">
                                                       <div x-show="condition === 'good'"
                                                           ...
                                                           <div class="relative">
                                                               <input type="number"
                                                                   wire:model.live="thermohygrometerConditions.{{ $thermohygrometerId }}.temperature"
                                                                   class="shadow-sm border @error('thermohygrometerConditions.' . $thermohygrometerId . '.temperature') border-red-500 @else border-gray-300 @enderror rounded-lg w-full py-2.5 px-3 pr-8 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                                                   step="0.1"
                                                                   min="-50"
                                                                   max="100"
                                                                   placeholder="25.5">
                                                               <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                                   <span class="text-gray-400 text-xs font-medium">°C</span>
                                                               </div>
                                                           </div>
                                                           @error('thermohygrometerConditions.' . $thermohygrometerId . '.temperature')
                                                               <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                                           @enderror
                                                       </div>
                                                       <div x-show="condition !== 'good'"
                                                           ...
                                                           class="{{ (isset($thermohygrometerConditions[$thermohygrometerId]['condition']) && $thermohygrometerConditions[$thermohygrometerId]['condition'] === 'good') ? 'hidden' : '' }}"
                                                           x-cloak>
                                                           <div class="flex items-center justify-center h-10 bg-gray-50 rounded-lg border border-gray-200">
                                                               <span class="text-gray-400 italic text-xs">Not applicable</span>
                                                           </div>
                                                       </div>
                                                   </td>
                                                   <td class="px-4 py-4 text-sm text-gray-900 align-top border-r border-gray-100">
                                                       <div x-show="condition === 'good'"
                                                           ...
                                                           <div class="relative">
                                                               <input type="number"
                                                                   wire:model.live="thermohygrometerConditions.{{ $thermohygrometerId }}.humidity"
                                                                   class="shadow-sm border @error('thermohygrometerConditions.' . $thermohygrometerId . '.humidity') border-red-500 @else border-gray-300 @enderror rounded-lg w-full py-2.5 px-3 pr-8 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
                                                                   step="0.1"
                                                                   min="0"
                                                                   max="100"
                                                                   placeholder="65.0">
                                                           ...
                                                           @error('thermohygrometerConditions.' . $thermohygrometerId . '.humidity')
                                                               <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                                           @enderror
                                                       </div>
                                                       <div x-show="condition !== 'good'"
                                                   ...
                                                   <td class="px-4 py-4 text-sm text-gray-900 align-top">
                                                       <div x-show="condition === 'damaged'"
                                                           ...
                                                           <div class="relative">
                                                               <textarea
                                                                   wire:model.live="thermohygrometerConditions.{{ $thermohygrometerId }}.description"
                                                                   class="shadow-sm border @error('thermohygrometerConditions.' . $thermohygrometerId . '.description') border-red-500 @else border-red-300 @enderror rounded-lg w-full py-2.5 px-3 text-sm resize-none focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 bg-red-50"
                                                                   rows="3"
                                                                   placeholder="⚠️ Required: describe the damage in detail..."></textarea>
                                                           ...
                                                           @error('thermohygrometerConditions.' . $thermohygrometerId . '.description')
                                                               <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                                           @enderror
                                                       </div>
                                                       <div x-show="condition === 'good'"
                                                           ...
                                                           <div class="relative">
                                                               <textarea
                                                                   wire:model.live="thermohygrometerConditions.{{ $thermohygrometerId }}.description"
                                                                   class="shadow-sm border @error('thermohygrometerConditions.' . $thermohygrometerId . '.description') border-red-500 @else border-gray-300 @enderror rounded-lg w-full py-2.5 px-3 text-sm resize-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-green-50"
                                                                   rows="3"
