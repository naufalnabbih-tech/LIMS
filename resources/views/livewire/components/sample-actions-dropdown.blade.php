        ...
        function sampleDropdown() {
            return {
                ...
                callLivewireMethod(method, sampleId) {
                    // Call method on the parent SampleRawmatSubmission component
                    // Find the parent Livewire component by traversing up
                    const parentElement = document.querySelector('[wire\\:id]');
                    if (parentElement) {
                        const wireId = parentElement.getAttribute('wire:id');
                        window.Livewire.find(wireId).call(method, sampleId);
                    }
                    this.closeDropdown();
                },
