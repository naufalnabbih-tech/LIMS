    ...
    <div class="flex flex-col">
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-4">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Specification</h2>
                    <p class="text-sm text-gray-600 mt-1">Manage and define analysis specifications</p>
                </div>
                <div>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-gray-900">
                                    @if ($specification->reference_manyto_many_count > 0)
                                        <span
                                            ...
                                            {{ $specification->reference_manyto_many_count }} reference(s)
                                        </span>
                                    @else
                                        <span
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm">
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        <button wire:click="delete({{ $specification->id }})"
                                            ...
                                            {{ $specification->reference_manyto_many_count > 0 ? 'title=Cannot delete: Specification is being used by references' : '' }}
                                        ...
                                        @if ($specification->reference_manyto_many_count > 0)
                                            <span
                                                class="inline-flex items-center px-2 py-1 text-xs font-medium bg-yellow-100 text-yellow-800 rounded">
