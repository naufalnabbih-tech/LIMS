            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <div class="px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('sample-submissions') }}" wire:navigate class="text-sm text-blue-600 hover:text-blue-700 font-medium">View All</a>
                    </div>
                </div>
                                    ...
                                    <li class="relative">
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-gray-400 mt-1">{{ $activity['time_human'] }}</p>
                                            </div>
                                        </div>
                                    </li>
                                @endforeach
