                        ...
                        <form wire:submit.prevent="updateSample">
                            ...
                            <div class="mb-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <!-- Supplier -->
                                    <div class="space-y-2">
                                        <label for="edit_supplier" class="block text-sm font-semibold text-gray-700">
                                            <span class="flex items-center space-x-1">
                                    ...
                                    <div class="space-y-2 md:col-span-2">
                                        <div
                                            ...
                                            <div class="flex items-center h-5">
                                                <input type="checkbox" wire:model.live="edit_has_coa"
                                                    id="edit_has_coa"
                                ...
                                <div class="mb-8">
                                        ...
                                        <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                                            <div class="flex items-center justify-between">
                                                <div class="flex items-center space-x-3">
                                                    ...
                                                    <div>
                                                        <p class="text-sm font-medium text-blue-900">Current CoA File
                                                        </p>
                                                        <p class="text-xs text-blue-700">
                                                            {{ basename($sample->coa_file_path) }}</p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="space-y-2">
                                        <label for="edit_coa_file" class="block text-sm font-semibold text-gray-700">
                                            <span class="flex items-center space-x-1">
                                                <span>Upload New CoA File
                                                    {{ $sample && $sample->coa_file_path ? '(Optional - Leave empty to keep current file)' : '' }}</span>
                                                @if (!$sample || !$sample->coa_file_path)
                                                    <span class="text-red-500">*</span>
                                                @endif
                                            </span>
                                            <span class="text-xs text-gray-500 font-normal block mt-1">(PDF, DOC, DOCX,
                                                JPG, JPEG, PNG - Max 10MB)</span>
                                        </label>
                                        <div class="relative">
                                            ...
                                            <div class="mt-3 p-4 bg-green-50 border border-green-200 rounded-xl">
                                                <div class="flex items-center justify-between text-sm text-green-700">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div>
                                                            <p class="font-medium">New file selected</p>
                                                            <p class="text-xs text-green-600">
                                                                {{ $edit_coa_file->getClientOriginalName() }}
                                                            </p>
                                                        </div>
                                                    </div>

                                                    <!-- Tombol Remove -->
                                                    <button type="button" wire:click="removeEditCOAFile"
                                                        class="ml-4 p-1.5 text-red-600 hover:bg-red-50 rounded-md transition-colors"
                                                        title="Remove file">
