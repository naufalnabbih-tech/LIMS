<div>
    <div class="flex flex-col">
        ...
        @if (session()->has('error'))
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4" x-data="{ show: true }"
                x-show="show" x-init="setTimeout(() => show = false, 2000)" x-transition:leave="transition ease-in duration-300"
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-right text-sm">
                                    <div class="flex justify-end space-x-2">
                                        <button
                                            wire:click="openEditModal({{ $rm->id }}, '{{ addslashes($rm->name) }}', '{{ addslashes($rm->code) }}', '{{ $rm->category_id }}')"
            ...
            <div class="fixed inset-0 bg-gray-900/75 p-4 flex items-center justify-center z-50">
                <div class="relative w-full max-w-md bg-white rounded-2xl shadow-2xl p-8">
                    <div class="flex justify-between items-center pb-4 border-b">
                        <h3 class="text-2xl font-bold">{{ $isEditModalOpen ? 'Edit' : 'Add New' }} Raw Material</h3>
                    ...
                    <div class="mt-6">
                        ...
                        <form wire:submit="{{ $isEditModalOpen ? 'update' : 'store' }}">
                            <div class="mb-5">
                                <label for="rawmat-name" class="block text-sm font-bold mb-2">Raw Material Name</label>
                                <input type="text" id="rawmat-name" wire:model="name"
                            ...
                            <div class="mb-5">
                                <label for="rawmat-code" class="block text-sm font-bold mb-2">Internal Code</label>
                                <input type="text" id="rawmat-code" wire:model="code"
                                    placeholder="e.g., RM-001, RM-COPPER-01"
                            ...
                            <!-- Raw Material Category Dropdown -->
                            <div class="mb-5 relative" x-data="{
                                ...
                                <label class="block text-sm font-bold mb-2 text-slate-700">Raw Material Category</label>
                            ...
                            <div class="flex justify-end pt-5 border-t mt-6">
                                ...
                                <button type="submit"
                                    ...
                                    <span wire:loading.remove wire:target="{{ $isEditModalOpen ? 'update' : 'store' }}">
                                        {{ $isEditModalOpen ? 'Update' : 'Save' }} Raw Material
                                    </span>
