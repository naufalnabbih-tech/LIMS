<div id="sample-solder-submission-component">
    <div class="flex flex-col">
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200 mb-4">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <div>
                    <h2 class="text-xl font-semibold text-gray-900">Solder Sample Submission</h2>
                    <p class="text-sm text-gray-600 mt-1">Submit and manage solder samples for testing</p>
                </div>
            ...
            <div class="px-6 py-4 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Track the status of submitted solder samples</p>
                    </div>
                    <div class="w-64">
                        <div class="relative">
                            <input type="text"
                ...
                <table class="min-w-full divide-y divide-gray-200" style="position: relative;">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse ($samples as $sample)
                            @include('livewire.sample-solder-submission.components.sample-table-row', ['sample' => $sample])
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-12 text-center">
                                    <livewire:components.empty-state
                                        title="No samples submitted"
                                        description="Start by submitting your first solder sample"
