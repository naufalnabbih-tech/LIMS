...
namespace App\Livewire\SampleSolderSubmission\Components;
...
class CreateSampleForm extends Component
{
    ...
    {
        $this->categories = Category::where('type', 'solder')->get();  // ✅ GANTI KE 'solder'
    ...
    public function submit()
    {
        try {
            ...
            Sample::create([
                'sample_type' => 'solder',  // ✅ GANTI KE 'solder'
            ...
            session()->flash('message', 'Solder sample submitted successfully!');  // ✅ GANTI MESSAGE
            $this->hide();
    ...
    {
        return view('livewire.sample-solder-submission.components.create-sample-form');  // ✅ GANTI VIEW PATH
    }
}
