...
class SolderSpecification extends Component
{
    use WithPagination;
    ...
    public function delete($id)
    {
        try {
            ...
            if ($specification->solderReferenceManytoMany()->count() > 0) {
                session()->flash('error', 'Specification tidak dapat dihapus karena masih digunakan oleh solder reference.');
                return;
            }
